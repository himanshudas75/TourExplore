...
const seedDB = async () => {
  ...
  for (let i = 0; i < 50; i++) {
    ...
    const tourspot = new Tourspot({
      ...
      description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem quibusdam doloribus blanditiis repellat soluta nesciunt corrupti iste saepe, quaerat magnam rem quod voluptatibus commodi, perferendis ipsam officia tempora fugiat iusto.',
